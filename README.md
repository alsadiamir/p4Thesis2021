...
|   <img src="/misc/img/P4img-multiple_cloning.png" alt="tunnel.png" style="zoom:50%;"/> |A 6 hosts, 1 switch network that clones every packet exchanged coming from h1 to h4, from h2 to h5 and from h3 to h6.|
