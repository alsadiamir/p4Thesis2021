...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.addLink(spine1, spine2, port1=3,port2=3, delay="200ms")
        self.addLink(leaf2, spine2, port1=3,port2=2)
        self.addLink(spine1, leaf1, port1=4,port2=2)

        # IPv4 host attached to leaf 1
        h4 = self.addHost('h4', cls=IPv4Host, mac="00:00:00:00:00:40",
                           ip='10.0.4.1/24', gw='10.0.4.254')

        self.addLink(h4, leaf1, port1=0,port2=1)

        # IPv4 hosts attached to leaf 2
        h1 = self.addHost('h4', cls=IPv4Host, mac="00:00:00:00:00:10",
                          ip='10.0.1.1/24', gw='10.0.1.254')
