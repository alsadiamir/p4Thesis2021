...
public class InterpreterImpl extends AbstractHandlerBehaviour
    ...
    private static Logger log = LoggerFactory.getLogger(InterpreterImpl.class);
...
/*                    .put(Criterion.Type.IPV6_DST, "hdr.ipv6.dstAddr")
...
//        if(ethPkt.getEtherType() == TYPE_MYTUNNEL){
//            log.info("PACKET PORT = "+portNum);
//        }
