...
/**
 * Device configuration object for the IPv4 fabric tutorial application.
 */
public class FabricDeviceIpv4Config extends Config<DeviceId> {

    public static final String CONFIG_KEY = "fabricDeviceIpv4Config";
    ...
    /**
     * Gets the SRv4 segment ID (SID) of the switch.
     *
     * @return IP address of the router. Or null if not configured.
     */
    public Ip4Address mySid() {
