...
class BasicAndTunnelTopo(Topo):
    def __init__(self, sw_path, json_path, thrift_port, pcap_dump, **opts):
        ...
        self.addLink(switch1, switch2, port1 = 3, port2 = 1)
        self.addLink(host3, switch2, port1 = 0, port2 = 2)
        self.addLink(host4, switch2, port1 = 0, port2 = 3)


def main():
    topo = BasicAndTunnelTopo(args.behavioral_exe, args.json, args.thrift_port, args.pcap_dump)
